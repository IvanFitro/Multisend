...
interface IREC20 {
    ...
    //Returns a bool result of the indicated operation
    function MultisendTransfer(address sender, address receiver, uint256 numTokens) external returns (bool);
...
contract ERC20 is IREC20 {
    ...
    string public constant name = "1Hour";
    string public constant symbol = "1HR";
    ...
    function MultisendTransfer(address sender, address receiver, uint256 numTokens) public override returns (bool){
